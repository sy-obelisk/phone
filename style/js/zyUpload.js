        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    // 创建不带有拖动的html
                    html += '<form id="uploadForm" name="upiframe" action="' + para.url + '" method="post" enctype="multipart/form-data">';
                    html+='<input type="hidden" name="bactfun" id="bactfun" value="upcallbact"/>';
                    html += '	<div class="upload_box">';
                    html += '		<div class="upload_main single_main">';
                    html += '				<div class="add_upload" style="display: none">';
                    html += '						<div class="uploadImg"></div>';
                    html += '				</div>';
                    html += '			<div class="status_bar add-img inb filePicker" style="vertical-align: top;">';
                    html += '					<input id="fileImage" type="file" name="upload" ' + multiple + '><img src="style/images-4/add-img2.png" style="width: 1.2rem" alt="">';
                    html += '			</div>';
                    html += '		</div>';
                    html += '		<div class="upload_submit" style="display: none">';
                    html += '			<button type="button" id="fileSubmit" class="upload_submit_btn"></button>';
                    html += '		</div>';
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                if (file.type.indexOf("image") == 0) {
                    html += '<div id="uploadList_' + file.index + '" class="upload_append_list up-img">';
                    ...
                    html += '			<a href="' + e.target.result + '" class="swipebox" title="My Caption"><img id="uploadImage_' + file.index + '" class="upload_image" src="' + e.target.result + '"  /></a>';
                    html += '		</div>';
                    html += '</div>';
